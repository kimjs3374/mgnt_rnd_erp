 ...
 *
 * ⚠ 계상 탭의 「비목 단위」 증빙 보관(`EvidenceAttachments`)은 뺐다(2026-09-04) — 계상 단계에서
 *   필요한 건 실물 증빙이 아니라 「무슨 서류를 어떤 양식으로 쓸 것인가」였다. 그건 계상 탭의
 *   `FormTemplates`(서식·문서 통일화)가 맡는다. 실물 증빙은 여기, **건 단위로만** 붙는다.
 *
