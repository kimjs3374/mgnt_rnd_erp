...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // 내부 연구원 명부(2026-09-04 사용자 지시). 단계 셋 **아래**에 둔다 —
      // 단계는 「과제가 어디까지 왔나」고 이건 「누가 있나」라 성격이 다르다.
      // ⚠ 성격만 보면 업체 대장처럼 「회사」 그룹이 맞다(여러 과제가 같은 사람을 쓴다).
      //   사용자가 과제 관리 안에서 쓰겠다고 해서 여기 뒀다. 옮기려면 이 한 줄이다.
      { title: "연구원", url: "/researchers" },
    ],
  },
  {
    title: "회사",
